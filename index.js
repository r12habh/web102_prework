...
const unfundedGamesString = `
    A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} ${totalGames === 1 ?
         "game" : "games"}. Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" 
 ...
 * Skills used: event listeners, DOM manipulation, string methods
 */
...
function searchGames() {
    ...
    // clear the current games display and add the filtered games
    deleteChildElements(gamesContainer);
...
// allow pressing 'Enter' in the search bar to trigger the search
